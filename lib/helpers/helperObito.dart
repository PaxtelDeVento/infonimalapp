...
class DatabaseHelperObito {
  //definir as colunas da tabela
  String animaisTable = 'obito';
  ...
  static late DatabaseHelperObito _databaseHelper;
  static late Database _database;

  //construtor nomeado para criar instância da classe
  DatabaseHelperObito._createInstance();

  factory DatabaseHelperObito() {
    _databaseHelper = DatabaseHelperObito._createInstance();
  ...
  void _createDB(Database db, int newVersion) async {
    await db.execute(
        'CREATE TABLE  $animaisTable ($colBrinco INTEGER, $colPeso REAL, $colSexo TEXT, $colPreco REAL, $colOrigem TEXT, $colRaca TEXT, $colDataNascimento TEXT, $colDataAquisicao)');
  }
